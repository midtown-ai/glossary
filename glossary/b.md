...
# Backpropagation
 ...
 See also [Activation Function], [Derivative Chain Rule], [Feedforward Neural Network], [Kernel Filter], [Loss Function], [Neural Network], [Vanishing Gradient Problem], [Variational Autoencoder Reparametrization Trick]
...
# Bag Of Words
 ...
 See also [Natural Language Processing], [Recurrent Neural Network], [Word2Vec]
...
# Bagging
 ...
 See also [Boosting], [Decision Tree], [Ensemble Method], [Random Forest], [Weak Learner]
...
# Balanced Fitting
 ...
 See also [Overfitting], [Underfitting]
...
# Batch 
 ...
 See also [Batch Size], [Epoch], [Iteration]
...
# Batch Gradient Descent
 ...
 See also [Gradient Descent], [Mini-Batch Gradient Descent]
...
# Batch Normalization
 ...
 See also [Exploding Gradient Problem], [Sigmoid Activation Function], [Vanishing Gradient Problem]
...
P(B|A) is the probability of event B given A.
 ...
 See also [Bayes Inference], [Naive Bayes]
...
P(A|B) = ----------------
 ...
 See also [Bayesian Network], [Bayes Theorem]
...
# Bayesian Optimization Sampling Method
 ...
 See also [Active Learning], [Grid Search], [Hyperparameter], [Random Search], [Surrogate Model]

# Bayesian Search
 Searching for a value using the bayesian optimization sampling method. See also [Bayesian Optimization Sampling Method], [Hyperparameter Tuning]
...
# BERT Classification
 ...
 See also [Bidirectional Encoder Representations from Transformers]
...
# Bias
 ...
 See also [Activation Function], [Balanced Fitting], [Bias-Variance Trade-Off], [Overfitting], [Underfitting], [Variance]
...
# BERT Model
 ...
 See also [Attention Score], [Attention-Based Model], [BERT Classification], [Masked Language Modeling], [Name Entity Recognition], [Next Sentence Prediction], [Tokenizer], [Transformer Model]
...
# BRNN
 ...
 See also [Recurrent Neural Network]

 Big Data :: See also [Deep Learning], [Expert System], [Machine Learning]
...
# Binary Classification
 ...
 See also [Binary Cross-Entropy Loss Function], [Classification], [Multiclass Classification], [Support Vector Machine]
...
binary cross-entropy loss = c = sum(0, 1, Pi * log (1/Qi) = Po * log(1/Qo) + (1-Po) * log(1/Q1)
 ...
 See also [Binary Classifier], [Cross-Entropy Loss Function], [Entropy], [Loss Function]
...
# BLIP Model
 ...
 See also [CLIP Model], [Image Reconstruction], [Multimodal Translation], [Text Reconstruction]
...
# Boltzmann Machine
 ...
 See also [Deep Belief Network], [Restricted Boltzmann Machine], [Unsupervised Deep Learning Model], [Unsupervised Learning]
...
# Boosting
 ...
 See also [AdaBoost], [Bagging], [Boosting Step Size], [Gradient Boosting], [Weak Learner], [XGBoost]

# Boosting Step Size

 See also [Boosting], [Hyperparameter]
